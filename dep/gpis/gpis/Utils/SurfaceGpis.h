...
#ifndef GPIS_UTILS_SURFACEGPIS_H_
#define GPIS_UTILS_SURFACEGPIS_H_
...
namespace gpis {
	...
	public:		// Public interface
		...
		/// Create a surface based on the given prior.
		/// \param _prior:
		SurfaceGpis(Kernel *_kernel, Mean *_mean);

		/// Add data points.
		void addData(const arma::mat &_data);
		...
		/// Get data points.
		void data(pcl::PointCloud<pcl::PointXYZ> &_data) const;

		/// Get mesh
		void mesh(pcl::PointCloud<pcl::PointXYZ> &_cloud, std::vector<pcl::Vertices> &_polygons) const;
	...
	private:	// Private interface
		...
		void redrawCloud(pcl::visualization::PCLVisualizer *_viewer, arma::mat _grads);
		void drawPoint(pcl::visualization::PCLVisualizer *_viewer, const pcl::PointXYZ &_point, const std::string &_name);
		void drawLine(pcl::visualization::PCLVisualizer *_viewer, const pcl::PointXYZ &_p1, const pcl::PointXYZ &_p2, const std::string &_name, unsigned _r=255, unsigned _g=0, unsigned _b=255);
	...
	private:	//	 members
		...
		std::vector<pcl::Vertices> mPolygons;
		pcl::PointCloud<pcl::PointXYZ> mCloud;
		pcl::PointCloud<pcl::PointXYZ> mCloudData;
		arma::mat mData;
		arma::mat mDataGrads;
	
	private:
		const std::vector<double> cParulaMap = { 
